    (function () {
        var duoworldFrameworkShellLauncherUserprofileCtrl = function ($scope, $rootScope, $mdDialog, $window, $http, $auth, notifications, $charge, $objectstore, $storage, $uploader) {
        ...
        var changePasswordCtrl = function ($scope, $rootScope, $mdDialog, $http, notifications) {
            ...
            $scope.submit = function () {
                ...
                if ($scope.newPassword === $scope.confirmNewPassword) {
                    ...
                    console.log(window.location.host + '/auth/ChangePassword/' + $scope.oldPassword + '/' + $scope.newPassword);
                    $http.get('/auth/ChangePassword/' + $scope.oldPassword + '/' + $scope.newPassword)
    ...
    mambatiFrameworkShell.filter("filterByPattern", ['$rootScope', function ($rootScope) {
