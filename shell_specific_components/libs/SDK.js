...
! function (e) {
    if ("object" == typeof exports && "undefined" != typeof module) module.exports = e();
        ...
        var f;
        "undefined" != typeof window ? f = window : "undefined" != typeof global ? f = global : "undefined" != typeof self && (f = self), f.SIP = e()
    }
}(function () {
                        ...
                        UA.prototype.loadConfig = function (configuration) {
                            ...
                            this.contact = {
                                ...
                                uri: new SIP.URI('sip', SIP.Utils.createRandomToken(8), settings.viaHost, null, {
                                    transport: ((settings.hackWssInTransport) ? 'wss' : 'ws')
                                }),
  ...
  [].concat(stunServers).forEach(function (server) {
                    ...
                    MediaHandler.prototype = Object.create(SIP.MediaHandler.prototype, {
                        ...
                        setDescription: {
                            writable: true,
                            value: function setDescription(sdp) {
                                var rawDescription = {
